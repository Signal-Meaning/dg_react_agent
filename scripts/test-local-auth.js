...
/**
 * Local test script to simulate the GitHub Actions debug workflow
 * This tests the same authentication steps that the GitHub Action performs
 */
...
console.log('🔍 Testing local authentication with GitHub Package Registry...\n');
...
if (!process.env.GITHUB_TOKEN) {
  ...
  console.log('   node scripts/test-local-auth.js');
  process.exit(1);
}
...
// Test 6: Test package publishing (dry run) - THE KEY TEST
...
console.log('   2. Find your GITHUB_TOKEN');
...
console.log('If the dry run fails, it indicates the issue with the GITHUB_TOKEN.');
console.log('\n💡 Next steps:');
