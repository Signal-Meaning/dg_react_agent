...
| Manual mic + OpenAI proxy (host audio) | **Still failing** — **`backend-20260408-142135`** pattern (**`SHELX.`**, etc.); **2026-04-04** retest after server restart: **same observables** — [MANUAL-MIC-OPENAI-PROXY-REPORT-2026-04-08.md](./MANUAL-MIC-OPENAI-PROXY-REPORT-2026-04-08.md) |
