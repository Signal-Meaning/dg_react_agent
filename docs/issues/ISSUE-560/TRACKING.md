...
| OpenAI proxy **Server VAD** Phase 2b opt-in (Issue #560) | **Done (2026-04-04)** — **`Settings.agent.useOpenAIServerVad`**; `translator.ts` + `server.ts`; Jest *Phase 2b* + full mock integration green |
