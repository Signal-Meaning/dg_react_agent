...
- **Manual gap:** Host-mic repro steps: [MANUAL-REPRO-HOST-MIC-OPENAI-PROXY.md](./MANUAL-REPRO-HOST-MIC-OPENAI-PROXY.md). Log/analysis: [MANUAL-MIC-OPENAI-PROXY-REPORT-2026-04-08.md](./MANUAL-MIC-OPENAI-PROXY-REPORT-2026-04-08.md). **2026-04-04:** servers restarted, repro rerun — **same observables** as before (see repro doc retest table).
