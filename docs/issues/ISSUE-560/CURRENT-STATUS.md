...
**Last updated:** 2026-04-08 (**Manual mic still failing** vs Playwright real-API green: debug log **`packages/voice-agent-backend/backend-20260408-111420.log`** — upstream STT **`Transcript (.)`**, generic assistant line, then **append-only** tail with **no further commit/transcription**. Reporter: UI showed **"It was."** / **"."** as user text — **not** spoken. See [MANUAL-MIC-OPENAI-PROXY-REPORT-2026-04-08.md](./MANUAL-MIC-OPENAI-PROXY-REPORT-2026-04-08.md). Prior: Playwright **`USE_REAL_APIS=1`** OpenAI + Live 18 passed / 2 skipped (2026-04-04); [NEXT-STEP.md](./NEXT-STEP.md).)
