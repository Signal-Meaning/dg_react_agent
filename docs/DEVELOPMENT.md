...
3. **Creates GitHub Issue**: Uses release checklist template (`.github/ISSUE_TEMPLATE/release-checklist.md`)
...
- **Release Checklist** (`.github/ISSUE_TEMPLATE/release-checklist.md`): Use for every release (patch = minimal docs; minor/major = full documentation set)
