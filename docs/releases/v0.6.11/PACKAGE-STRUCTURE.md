# Package Structure: @signal-meaning/deepgram-voice-interaction-react@v0.6.11
...
```
signal-meaning-deepgram-voice-interaction-react-v0.6.11/
...
```bash
npm install @signal-meaning/deepgram-voice-interaction-react@v0.6.11
```
