# Package Structure: @signal-meaning/deepgram-voice-interaction-react@v0.7.9
...
```
signal-meaning-deepgram-voice-interaction-react-v0.7.9/
...
```bash
npm install @signal-meaning/deepgram-voice-interaction-react@v0.7.9
```
