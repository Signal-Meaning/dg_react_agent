# Package Structure: @signal-meaning/deepgram-voice-interaction-react@v0.7.19
...
```
signal-meaning-deepgram-voice-interaction-react-v0.7.19/
...
```bash
npm install @signal-meaning/deepgram-voice-interaction-react@v0.7.19
```
