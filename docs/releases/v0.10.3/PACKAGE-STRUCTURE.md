# Package Structure: @signal-meaning/voice-agent-react@v0.10.3
...
```
signal-meaning-voice-agent-react-v0.10.3/
...
```bash
npm install @signal-meaning/voice-agent-react@v0.10.3
```
