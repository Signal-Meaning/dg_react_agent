# Package Structure: @signal-meaning/voice-agent-react@v0.10.1
...
```
signal-meaning-voice-agent-react-v0.10.1/
...
```bash
npm install @signal-meaning/voice-agent-react@v0.10.1
```
