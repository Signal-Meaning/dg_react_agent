# Package Structure: @signal-meaning/deepgram-voice-interaction-react@v0.5.1
...
```
signal-meaning-deepgram-voice-interaction-react-v0.5.1/
...
```bash
npm install @signal-meaning/deepgram-voice-interaction-react@v0.5.1
```
