# Package Structure: @signal-meaning/voice-agent-react@v0.10.5
...
```
signal-meaning-voice-agent-react-v0.10.5/
...
```bash
npm install @signal-meaning/voice-agent-react@v0.10.5
```
