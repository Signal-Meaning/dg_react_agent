# Package Structure: @signal-meaning/deepgram-voice-interaction-react@v0.7.11
...
```
signal-meaning-deepgram-voice-interaction-react-v0.7.11/
...
└── test-app/                 # Test application demonstrating component usage
    ...
    │   │   ├── openai-proxy-e2e.spec.js   # OpenAI proxy E2E (9 tests)
...
```bash
npm install @signal-meaning/deepgram-voice-interaction-react@v0.7.11
```
