# Package Structure: @signal-meaning/deepgram-voice-interaction-react@v0.6.12
...
```
signal-meaning-deepgram-voice-interaction-react-v0.6.12/
...
```bash
npm install @signal-meaning/deepgram-voice-interaction-react@v0.6.12
```
