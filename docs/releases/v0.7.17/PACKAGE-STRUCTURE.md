# Package Structure: @signal-meaning/deepgram-voice-interaction-react@v0.7.17
...
```
signal-meaning-deepgram-voice-interaction-react-v0.7.17/
...
├── tests/                     # Jest unit and integration tests (added in v0.7.17)
│   ├── *.test.ts / *.test.tsx
│   ├── api-baseline/
│   ├── fixtures/
│   ├── utils/
...
- **`tests/`**: Jest unit and integration tests (included in package as of v0.7.17)
...
```bash
npm install @signal-meaning/deepgram-voice-interaction-react@v0.7.17
```
...
# Verify tests are included (v0.7.17+)
ls node_modules/@signal-meaning/deepgram-voice-interaction-react/tests/
```
