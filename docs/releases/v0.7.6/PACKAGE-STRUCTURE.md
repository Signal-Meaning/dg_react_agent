# Package Structure: @signal-meaning/deepgram-voice-interaction-react@v0.7.6
...
```
signal-meaning-deepgram-voice-interaction-react-v0.7.6/
...
```bash
npm install @signal-meaning/deepgram-voice-interaction-react@v0.7.6
```
