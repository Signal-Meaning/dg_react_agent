# Package Structure: @signal-meaning/voice-agent-react@v0.11.0
...
**Backend package (same repo, separate publish):** `@signal-meaning/voice-agent-backend@0.2.12` — see `packages/voice-agent-backend/package.json` and README (OpenAI proxy, scheduler, logging).
...
```
signal-meaning-voice-agent-react-v0.11.0/
...
```bash
npm install @signal-meaning/voice-agent-react@v0.11.0
```
