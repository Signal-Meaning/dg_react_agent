# Package Structure: @signal-meaning/deepgram-voice-interaction-react@v0.6.5
...
```
signal-meaning-deepgram-voice-interaction-react-v0.6.5/
...
- **`dist/utils/deep-equal.d.ts`**: Deep equality comparison utility for dependency tracking
- **`dist/utils/option-comparison.d.ts`**: Agent options comparison utilities

## Package Size Information

- **Total Package Size**: ~1.6 MB (tarball)
