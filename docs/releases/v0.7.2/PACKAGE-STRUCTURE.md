# Package Structure: @signal-meaning/deepgram-voice-interaction-react@v0.7.2
...
```
signal-meaning-deepgram-voice-interaction-react-0.7.2/
...
- **Total Package Size**: 1.8 MB (tarball)
