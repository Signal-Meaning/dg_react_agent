# Package Structure: @signal-meaning/deepgram-voice-interaction-react@v0.6.10
...
```
signal-meaning-deepgram-voice-interaction-react-v0.6.10/
...
- **dist/**: ~207 KB (index.js + index.esm.js + type definitions)
- **docs/**: ~5.8 MB (includes all documentation and test-app)
- **test-app/**: Included for reference and E2E testing

## Installation

```bash
npm install @signal-meaning/deepgram-voice-interaction-react@v0.6.10
```
