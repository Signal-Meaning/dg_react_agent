# Package Structure: @signal-meaning/deepgram-voice-interaction-react@v0.7.16
...
```
signal-meaning-deepgram-voice-interaction-react-v0.7.16/
...
```bash
npm install @signal-meaning/deepgram-voice-interaction-react@v0.7.16
```
