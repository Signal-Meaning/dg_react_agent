# Package Structure: @signal-meaning/voice-agent-react@v0.10.2
...
```
signal-meaning-voice-agent-react-v0.10.2/
...
```bash
npm install @signal-meaning/voice-agent-react@v0.10.2
```
