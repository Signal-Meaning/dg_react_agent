# Package Structure: @signal-meaning/voice-agent-react@v0.9.4
...
```
signal-meaning-voice-agent-react-v0.9.4/
...
├── packages/
│   └── voice-agent-backend/  # Backend package (0.2.4)
...
```bash
npm install @signal-meaning/voice-agent-react@v0.9.4
```
