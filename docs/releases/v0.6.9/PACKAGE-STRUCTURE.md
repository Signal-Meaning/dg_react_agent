# Package Structure: @signal-meaning/deepgram-voice-interaction-react@v0.6.9
...
```
signal-meaning-deepgram-voice-interaction-react-v0.6.9/
...
```bash
npm install @signal-meaning/deepgram-voice-interaction-react@v0.6.9
```
