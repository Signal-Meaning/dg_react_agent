# Package Structure: @signal-meaning/deepgram-voice-interaction-react@v0.6.3
...
```
signal-meaning-deepgram-voice-interaction-react-v0.6.3/
...
```bash
npm install @signal-meaning/deepgram-voice-interaction-react@0.6.3
```
