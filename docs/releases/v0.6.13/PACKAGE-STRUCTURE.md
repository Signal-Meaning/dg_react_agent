# Package Structure: @signal-meaning/deepgram-voice-interaction-react@v0.6.13
...
```
signal-meaning-deepgram-voice-interaction-react-v0.6.13/
...
```bash
npm install @signal-meaning/deepgram-voice-interaction-react@v0.6.13
```
