# Package Structure: @signal-meaning/deepgram-voice-interaction-react@v0.7.5
...
```
signal-meaning-deepgram-voice-interaction-react-v0.7.5/
...
```bash
npm install @signal-meaning/deepgram-voice-interaction-react@v0.7.5
```
