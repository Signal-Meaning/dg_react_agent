# Package Structure: @signal-meaning/deepgram-voice-interaction-react@v0.7.3
...
```
signal-meaning-deepgram-voice-interaction-react-v0.7.3/
...
```bash
npm install @signal-meaning/deepgram-voice-interaction-react@v0.7.3
```
