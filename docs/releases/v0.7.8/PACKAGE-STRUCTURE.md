# Package Structure: @signal-meaning/deepgram-voice-interaction-react@v0.7.8
...
```
signal-meaning-deepgram-voice-interaction-react-v0.7.8/
...
```bash
npm install @signal-meaning/deepgram-voice-interaction-react@v0.7.8
```
