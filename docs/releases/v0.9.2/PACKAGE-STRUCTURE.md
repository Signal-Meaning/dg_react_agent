# Package Structure: @signal-meaning/voice-agent-react@v0.9.2
...
```
signal-meaning-voice-agent-react-v0.9.2/
...
├── packages/
│   └── voice-agent-backend/  # Backend package (0.2.2)
...
```bash
npm install @signal-meaning/voice-agent-react@v0.9.2
```
