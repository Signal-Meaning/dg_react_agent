# Package Structure: @signal-meaning/deepgram-voice-interaction-react@v0.6.15
...
```
signal-meaning-deepgram-voice-interaction-react-v0.6.15/
...
- **dist/**: ~213 KB (index.js + index.esm.js)
- **docs/**: ~1.5 MB
- **test-app/**: ~4.4 MB
...
```bash
npm install @signal-meaning/deepgram-voice-interaction-react@v0.6.15
```
