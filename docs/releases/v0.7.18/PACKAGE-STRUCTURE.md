# Package Structure: @signal-meaning/deepgram-voice-interaction-react@v0.7.18
...
```
signal-meaning-deepgram-voice-interaction-react-v0.7.18/
...
```bash
npm install @signal-meaning/deepgram-voice-interaction-react@v0.7.18
```
