...
import { loadInstructionsFromFile } from '../src/utils/instructions-loader.cjs';
...
describe('DEEPGRAM_INSTRUCTIONS File and Environment Override', () => {
  ...
  describe('Instructions Loading from File', () => {
    ...
    it('should throw error when file loading fails', async () => {
      ...
      // Act & Assert
      await expect(loadInstructionsFromFile()).rejects.toThrow('File not found');
    });
  });
  ...
  describe('Error Handling', () => {
    it('should handle file read errors gracefully', async () => {
      ...
      // Act & Assert
      await expect(loadInstructionsFromFile()).rejects.toThrow('File system error');
    });
